      ...
      <div className="z-10 flex flex-col items-center gap-12 w-full max-w-7xl">
        ...
        <footer className="text-sm text-gray-500 animate-in fade-in duration-1000 delay-500 text-center space-y-2">
          ...
          <div className="flex gap-4 justify-center text-xs">
            <a href="https://instagram.com/shantanu" target="_blank" className="hover:text-pink-400 transition-colors">Instagram: @shantanu</a>
            <span className="text-gray-700">|</span>
            <a href="https://x.com/shantanu" target="_blank" className="hover:text-blue-400 transition-colors">X: @shantanu</a>
            <span className="text-gray-700">|</span>
            <a href="https://youtube.com/@Catchai" target="_blank" className="hover:text-red-400 transition-colors">YouTube: Catchai</a>
          </div>
        </footer>
      </div>
    </main>
